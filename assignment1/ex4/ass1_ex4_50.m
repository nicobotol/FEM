%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  RUN OVER DIFFERENT NUMBER OF NODES WITH 50% RADIUS CONNECTIONS         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%--- Input file ----------------------------------------------------------%
file_vector = [ ...
  "C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\ex4\mesh1_50.m", ...
  "C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\ex4\mesh2_50.m" ...
  "C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\ex4\mesh3_50.m" ...
  "C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\ex4\mesh4_50.m" ...
  %"C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\ex4\mesh5.m" 
  ];

file_number = size(file_vector, 2);
node_number_vector = [10 29 58 202];% 406]; % number of the node where the force is applied
...
%%
%--- Plot results --------------------------------------------------------%                                                        
compliance_vs_node_50 = figure('Position', get(0, 'Screensize'));
plot(total_nodes, compl_vector, 'o', 'LineWidth', 3.5);
xlabel('Nodes')
ylabel('Compliance [J]')
title('Compliance for connection 50%')
set(gca, 'FontAngle', 'oblique', 'FontSize', 20)
saveas(compliance_vs_node_50, 'C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\compliance_vs_node_50.png','png');

displacement_vs_node_50 = figure('Position', get(0, 'Screensize'));
plot(total_nodes, disp_vector, 'o', 'LineWidth', 3.5)
xlabel('Nodes')
ylabel('Displacement [m]')
title('Displacement for connection 50%')
set(gca, 'FontAngle', 'oblique', 'FontSize', 20)
saveas(compliance_vs_node_50, 'C:\Users\Niccolò\Documents\UNIVERSITA\5° ANNO\FEM\assignment1\compliance_vs_node_50.png','png');
%%
return
