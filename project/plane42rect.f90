module plane42rect 
  ...
  private
  public :: plane42rect_ke, plane42rect_re, plane42rect_ss, shape, gauss_quadrature, gauss_quadrature_bmat, plane42rect_me

contains

  subroutine plane42rect_ke(xe, young, nu, dens, thk, ke)
    ...
    subroutine plane42rect_me(xe, dens, thk, me)
